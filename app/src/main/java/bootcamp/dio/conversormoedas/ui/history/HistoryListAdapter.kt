...
import bootcamp.dio.conversormoedas.core.extensions.formatCurrency
import bootcamp.dio.conversormoedas.data.model.Coin
import bootcamp.dio.conversormoedas.data.model.ExchangeResponseValue
import bootcamp.dio.conversormoedas.databinding.ItemHistoryBinding
...
class HistoryListAdapter : ListAdapter<ExchangeResponseValue, HistoryListAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(
        ...
        fun bind(item: ExchangeResponseValue) {
            ...
            binding.tvValue.text = item.conv.formatCurrency(coin.locale)
        }
    }
}
